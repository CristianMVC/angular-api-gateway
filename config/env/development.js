export default {
  ...
  ws2: { //v2 endpoints
    ...
    dnrpa: {
      ...
      token: {
        url: 'https://ssopublico-homologacion.jus.gov.ar/sso/connect/token',
        headers: {},
        query: {},
        body: {
          scope: 'apiGateway',
          grant_type: 'client_credentials',
          client_id: '5F0D3FBD816940989CAFA1545C61DD3B',
          client_secret: 'C595D24F8FA142DA93840D750832AC9E',
        },
      },
      personas: {
        url: 'https://servicios-homologacion.jus.gob.ar/mi-argentina/api/v1.0/personas',
      },
      cedulas: {
        url: 'https://servicios-homologacion.jus.gob.ar/mi-argentina/api/v1.0/cedulas/activar',
      },
      seguroAutomotor: {
        url: 'https://a.gde.gob.ar/ssn-tablero-web/api/v1/consultas/automotor/tarjetaseguro',
        security: {
