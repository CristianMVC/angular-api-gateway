    ...
    return `<tr>
            ...
            <tr>
              <td style="width: 500px;  padding: 0px 25px 10px 25px;">
                <p style="font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; ">${item.nombre}</p>
                </td>
            </tr>

            <tr>
              <td style="width: 500px;  padding: 0px 25px; ">
                <p style="font-family:Helvetica, arial, sans-serif; color:#333333; font-size:18px; line-height:0.8;font-weight: bolder;">
                  Acercate a la Junta para sacar turno. 
                </p>
              </td>
            </tr>
            <tr>
              <td style="width:500px; padding: 0px 25px;">
                <p style="width:100%; text-align:left;font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; font-weight: bolder; line-height: 0.5;">Direcci&oacute;n</p>
                <p style="width:100%; text-align:left;font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; ">${item.direccion}</p>
              </td>
            </tr>
            <tr>
              <td style="width:500px; padding: 0px 25px;">
                <p style="width:100%; text-align:left;font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; font-weight: bolder;line-height: 0.5;">Datos de contacto</p>
                        ...
                        <td style="background-color: #f5f5f5;" align="center">
                          <table cellpadding="0" cellspacing="0" width="100%" border="0" >
                            <tbody>
                              ...
                              <tr>
                                <td style="width:500px; padding: 0px 25px;">
                                  <p style="width:100%; text-align:left;font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; line-height:1.6; margin:0px;">Estos son los documentos y el lugar donde ten&eacute;s que concurrir para hacer el tr&aacute;mite de tu Certificado &Uacute;nico de Discapacidad.</p>
                                </td>
                              </tr>
                              <tr>
