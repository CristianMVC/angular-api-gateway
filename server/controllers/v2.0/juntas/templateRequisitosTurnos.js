const template = (nombre, juntas, requisitos) => {
  juntas = juntas.map((item) => {
    return `<tr>
            ...
            <tr>
              <td style="width: 500px;  padding: 0px 25px;">
                <p style="font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; line-height: 1.6; margin-top: 0;">${item.nombre}</p>
                </td>
            </tr>
            <tr>
              <td style="width: 500px;  padding: 0px 25px;">
                <p style="font-family:Helvetica, arial, sans-serif; color:#333333; font-size:18px; line-height:1.6;font-weight: bolder;">
                  Pod&eacute;s sacar turnos:
                </p>
                <ul style="width:100%; padding-left:25px;">
                  <li>
                    <p style="font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; font-weight: bold;">Por internet</p>
                    <table>
                      <tbody><tr>
                        <td style="">
                          <table cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%" border="0">
                            <tbody><tr>
                              <td style="word-break:break-word;font-size:0px;padding-right:15px;" align="left">
                                <table cellpadding="0" cellspacing="0" style="border-collapse:separate;" align="left" border="0">
                                  <tbody><tr>
                                    <td style="border:none;border-radius:5px;color:#FFFFFF;cursor:auto;padding:15px;" align="center" valign="middle" bgcolor="#2E7D33">
                                      <a href="${item.botonTurno}" style="width:100%;text-decoration:none;line-height:100%;background:#2E7D33;color:#FFFFFF;font-family:Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:16px;font-weight:bolder;text-transform:none;margin:0px; text-transform: uppercase;" target="_blank">Turno junta</a>
                                    </td>
                                  </tr>
                                </tbody></table>
                              </td>
                            ...
                            <tbody><tr>
                              <td style="word-break:break-word;font-size:0px;padding-right:15px;" align="left">
                                <table cellpadding="0" cellspacing="0" style="border-collapse:separate;" align="left" border="0">
                                  <tbody><tr>
                                    <td style="border:none;border-radius:5px;color:#FFFFFF;cursor:auto;padding:15px;" align="center" valign="middle" bgcolor="#2E7D33">
                                      <a href="${item.botonAsesoramiento}" style="width:100%;text-decoration:none;line-height:100%;background:#2E7D33;color:#FFFFFF;font-family:Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:16px;font-weight:bolder;text-transform:none;margin:0px; text-transform: uppercase;" target="_blank">Turno asesoramiento</a>
                                    </td>
                                  </tr>
                                </tbody></table>
                              </td>
                  ...
                  <li>
                    <p style="font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; font-weight: bold;padding-top: 20px">Personalmente en la Junta </p>
                    <p style="width:100%; text-align:left;font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; font-weight: bolder;">Direcci&oacute;n</p>
                    <p style="width:100%; text-align:left;font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px; ">${item.direccion}</p>
                    ...
                    <p style="width:100%; text-align:left;font-family:Helvetica, arial, sans-serif; color:#333333; font-size:16px;">${item.contacto}</p>
                  </li>
                </ul>
                </td>
            </tr>
