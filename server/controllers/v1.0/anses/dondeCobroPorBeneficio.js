...
/**
 * Request Donde Cobro Por Beneficio
...
function _request(params) {
  return new Promise((resolve, reject) => {
    ...
    request
      ...
      .set('SOAPAction', '"http://anses.gov.ar/DondeCobroWS"')
      .set('Accept', '*/*')
        ...
        try {
          ...
          if (parseInt(_data.Error.codigo) === 0) {
            ...
            reject(errorHandler({
              ...
              method: 'Controllers::Anses::DondeCobroPorBeneficio::ANSES-Error',
          ...
          reject(errorHandler({
            ...
            method: 'Controllers::Anses::DondeCobroPorBeneficio::ResponseParser',
            stack: e.message,
          }))
        }
      })
      .catch((e) => {
        reject(errorHandler({
          ...
          method: 'Controllers::Anses::DondeCobroPorBeneficio::Request',
          stack: e.message,
        }))
      })
  })
